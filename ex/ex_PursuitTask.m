...
%     newY = round(e.distance*sin(theta));
    ...
    msg('set 2 movingoval 0 %i %i %i %i %i %i %i %i',[e.fixX e.fixY e.size e.pursuitSpeed e.angle e.targetColor(1) e.targetColor(2) e.targetColor(3)]);
    ...
    % get pursuit onset time here - GetSecs call
    sendCode(codes.FIX_OFF);
