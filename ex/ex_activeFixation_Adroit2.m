...
%
    ...
    %%% prepare N stimuli to show with set (obj Ids: 2,3,4,5,6,7,...)
    ...
    %%% present N images (100ms each) with inter-image intervals (100ms each)
        ...
        for iimage = 1:e.imagesPerFixation
            ...
            if iimage < e.imagesPerFixation   % no interval for last image presented
    ...
    %%% N images have been presented, so now present a target to saccade to, after a
