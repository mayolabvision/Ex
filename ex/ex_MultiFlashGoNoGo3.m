function result = ex_MultiFlashGoNoGo3(e)
...
giveJuice(params.juiceX,params.juiceInterval,floor(params.juiceTTLDuration*e.rewardDist(flashes))); %changed to different duration PLS 10/29/20
