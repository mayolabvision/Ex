function result = ex_AniPursuitTask(e)
...
msg('set 2 movingoval 0 %i %i %i %i %i %f %i %i %i',[e.fixX e.fixY e.pursuit_size e.pursuitSpeed e.angle e.jumpSize e.targetColor(1) e.targetColor(2) e.targetColor(3)]);
